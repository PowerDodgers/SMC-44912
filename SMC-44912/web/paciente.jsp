                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <form class="form-horizontal" role="form">
                            <fieldset>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">ID_pessoa</label>
                                    <div class="col-sm-10">
                                        <br /><br /><select>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">ID_planosaude</label>
                                    <div class="col-sm-10">
                                        <br /><br /><select>
                                            <option>ID do plano de saúde</option>                                       
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
