                        ...
                        <form class="form-horizontal" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">Data da consulta</label>
                                    <div class="col-sm-10">
                                        <input type="text" placeholder="Digite a data" class="form-control" />
                                    </div>
                                </div>

                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">ID_ especialidade</label>
                                    <div class="col-sm-10">
                                    <br /><br /><br /><select>
                                            <option>ID da especialidade</option>                                       
                                        </select>
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">ID_ médico</label>
                                    <div class="col-sm-10">
                                    <br /><br /><select>
                                            <option>ID do médico</option>                                       
                                        </select>
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">ID_ paciente</label>
                                    <div class="col-sm-10">
                                    <br /><br /><select>
                                            <option>ID do paciente</option>                                       
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
