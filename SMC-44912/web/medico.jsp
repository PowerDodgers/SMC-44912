                        ...
                        <form class="form-horizontal" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="text" placeholder="Digite seu telefone" class="form-control" />
                                    </div>
                                </div>
                                
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">ID_ pessoa</label>
                                    <div class="col-sm-10">
                                        <br /><br /><select>
                                            <option>ID da pessoa</option>                                       
                                        </select>
                                    </div>
                                </div>
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">Crm</label>
                                    <div class="col-sm-10">
                                    <input type="text" placeholder="Digite seu crm" class="form-control" />
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">Matricula</label>
                                    <div class="col-sm-10">
                                    <input type="text" placeholder="Digite sua matricula" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
