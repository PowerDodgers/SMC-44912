                        ...
                        <form class="form-horizontal" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">Logra douro</label>
                                    <div class="col-sm-10">
                                        <input type="text" placeholder="Digite seu logradouro" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="text" placeholder="Digite seu bairro" class="form-control" />
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="form-group">
                                ...
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">ID_cidade</label>
                                    <div class="col-sm-10">
                                    <br /><br /><select>
                                            <option>ID da cidade</option>                                       
                                        </select>
                                    </div>
                                </div>
                                <!-- Text input-->
