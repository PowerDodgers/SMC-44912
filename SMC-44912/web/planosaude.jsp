            ...
            <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <form class="form-horizontal" role="form">
                            <fieldset>
                                <!-- Form Name -->
                                <legend>Cadastro seu plano</legend>

                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="textinput">Plano de saúde</label>
                                    <div class="col-sm-10">
                                        <input type="text" placeholder="Digite seu plano" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
